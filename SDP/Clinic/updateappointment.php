...
<html>
    <head>
        ...
        <link rel="stylesheet" href="updateappointment.css">
                ...
                <div class="appointment">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><a href='update.php?AppointmentID=" . $row['AppointmentID'] . "' class='edit-btn'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                            echo "</tr>";
                        }
                    } else {
